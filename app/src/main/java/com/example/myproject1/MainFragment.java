...
public class MainFragment extends BrowseSupportFragment implements OnItemViewClickedListener {
    ...
    private void setUI() {
        setTitle("Photos & Videos - TV app!!"); // our In-App title will be shown in top-right corner
    ...
    private void loadRows() {
        ...
        HeaderItem category2 = new HeaderItem(1, "Personal photos");
        ArrayObjectAdapter adapterForRow1 = new ArrayObjectAdapter(new MyPresenter());
        ArrayObjectAdapter adapterForRow2 = new ArrayObjectAdapter(new MyPresenter());
        ...
        adapterForRow2.add(new SingleRowView("Alexander", getContext().getResources().getDrawable(R.drawable.image_custom_1)));
        adapterForRow2.add(new SingleRowView("Alexander and Sergey", getContext().getResources().getDrawable(R.drawable.image_custom_2)));
        adapterForRow2.add(new SingleRowView("Alex has some fun!", getContext().getResources().getDrawable(R.drawable.image_custom_3)));
        ...
        windowAdapter.add(new ListRow(category2, adapterForRow2));
